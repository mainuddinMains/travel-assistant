    ...
    <div className="min-h-screen flex items-center justify-center p-4 bg-gradient-to-br from-travel-neutral-lightest to-travel-neutral-light/20">
      <div className="card w-full max-w-md animate-fade-in">
        ...
        <div className="text-center mb-6">
          ...
          <h1 className="text-2xl font-heading font-bold mb-2 bg-gradient-to-r from-travel-primary to-travel-primaryLight bg-clip-text text-transparent">{t('auth.loginTitle')}</h1>
          <p className="text-sm text-travel-neutral/70">{t('auth.loginSubtitle')}</p>
        </div>
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
          <TextField label={t('auth.emailLabel')} {...register('email')} error={errors.email && t('validation.email') as string} />
        ...
        <div className="mt-6 text-center">
          <span className="text-sm text-travel-neutral/70 mr-2">{t('auth.needAccount')}</span>
